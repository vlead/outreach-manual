...
+ Step 5 :: Click on =Manage Outreach Coordinators= it displays
            the list of current outreach coordinators

+ Step 6 :: Click on =Manage Documents= it displays the
            reference documents

+ Step 7 :: Click on =My Profile= it displays the details of
            the admin
...
+ Step 5 :: Click on =Manage Nodal Centers= button from left
            menu bar.

+ Step 6 :: Outreach Coordinator =Manage Nodal Centers= will
            show the details of the Nodal Centres Details
            and also allows to add a new =Nodal Center=.

+ Step 7 :: Click on =Manage Nodal Coordinator= button from left
            menu bar.

+ Step 8 :: Outreach Coordinator =Manage Nodal Coordinator= will
            show the details of the Nodal Coordinator Details
            and also allows to add a new =Nodal
            Coordinator=. 
+ Step 9 :: Click on =Manage Workshops= button from left
            menu bar.

+ Step 10 :: Outreach Coordinator =Manage Workshops= will show the following Details:
...
+ Step 11 :: Click on =Reference Documents= button from left
            menu bar.

+ Step 12 :: Outreach Coordinator =Reference Documents= will
            show the documents required to be uploaded in
             the outreach portal for all the workshops. 

+ Step 13 :: Click on =Logout= button from top right corner to exit. or else
     continue with other scenarios
...
+ Step 4 :: Click on =Pending Workshops= section from right menu bar. 
...
+ Step 3 :: Click on =Nodal Centers= button from left menu
            bar. The =Nodal Center Details= section will
            appear with the following details:

            + Name - <Nodal Center Name>
            + Location - <Nodal Center Location>

+ Step 4 :: Click on =Logout= button from top right corner
            to exit.
