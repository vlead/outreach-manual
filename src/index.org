...
+ Step 5 :: Enter the following details to create a New Workshop and
            ...
            + Workshop Version - <online/offline>
	      - online :: Virtual Labs are accessed from the internet.
	      - offline :: Virtual Labs are accessed from college
                           cloud HDD(Internet connection is not
                           required to access the labs)
            ...
            + Gateway IP of College - <gateway ip of college>
              (optional field for online workshops)

+ Step 6 :: Newly added Workshop will appear under =My Workshops=
            section if the workshop date is future. or else if the
            workshop is already done, it will appear under =Workshop
            History= section.
...
+ Step 5 :: Enter the following details to create a New Workshop and
	      ...
	      - offline :: Virtual Labs are accessed from college
            ...
            + Number of Labs Planned - <number of labs planned>
            + Date of Workshop - <date of workshop>
            + Gateway IP of College - <gateway ip of college> (optional field for online workshops)
...
+ Step 6 :: Newly added Workshop will appear under =Upcoming
            ...
            =Pending Action Workshops= section.
...
+ Step 2 :: Login as Nodal Coordinator (Please follow the steps mentioned in section [[Login Scenarios]])
