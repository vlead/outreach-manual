...
+ Step 5 :: Enter the following details to create a New Workshop and
	      ...
	      - online :: Virtual Labs are accessed from internet.
	      - offline :: Virtual Labs are accessed from college
                           cloud (Innternet connection is not
...
+ Step 7 :: Newly added Workshop will appear under =My Workshops=
            section if the workshop date is future. or else if the
            workshop is already done, it will appear under =Workshop
            History= section.

+ Step 9 :: Click on =Logout= button from top right corner to exit. or
     ...
     button.
	    ...
	    + For online workshop
	      ...
	      - Enter the =College MAC Address= value which is
                obtained during workshop is being conducted at the college
                or contact college cloud SysAdmin to get the mac
                address of the college cloud machine.
              - Click on =Compute Usage= button to get the Usage from
...
+ Step 7 :: Newly added Workshop will appear under =Upcoming
