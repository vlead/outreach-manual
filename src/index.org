     ...
     button.
	    ...
	    + For online workshop
	      ...
	      - Enter the =College MAC Address= value which is
                obtained when the workshop was conducted at the college.Visit for [[http://community.vlabs.ac.in/docs/user-manuals/college-cloud/installation-manual.html#sec-7-2][More information on getting MAC address]]
              - Click on =Compute Usage= button to get the Usage from
