     ...
     button.
	    ...
	    + For online workshop
	      ...
	      - Enter the =College MAC Address= value which is
                obtained when the workshop was conducted at the college.Visit for [[http://community.vlabs.ac.in/docs/college-cloud/installation-manual.html#orgdeb015d][More information on getting MAC address]]
              - Click on =Compute Usage= button to get the Usage from
